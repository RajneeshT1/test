    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
       ...
       final TextView nameTextView;
        ...
        public void bind(final int position) {
            ...
            //example Glide.with(context).load(getImage(my_drawable_image_name)).into(movieImageView);
            String imageName = getImageName(position);
            //write you code below this

            Glide.with(context)
                    .load(getImage("file:///android_drawable/batman.jpeg"))
                    .into(movieImageView);
            Glide.with(context)
                    .load(getImage("file:///android_drawable/deadpool.jpeg"))
                    .into(movieImageView);
            Glide.with(context)
                    .load(getImage("file:///android_drawable/doctor_strange.jpeg"))
                    .into(movieImageView);
            Glide.with(context)
                    .load(getImage("file:///android_drawable/ironman.jpeg"))
                    .into(movieImageView);
            Glide.with(context)
                    .load(getImage("file:///android_drawable/spiderman.jpeg"))
                    .into(movieImageView);
            Glide.with(context)
                    .load(getImage("file:///android_drawable/thor.jpeg"))
                    .into(movieImageView);
